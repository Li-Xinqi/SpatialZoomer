...
const datasetDescriptionList = [
  '<strong>Dataset 1:</strong> Xenium In Situ, Alzheimer\'s Disease Mouse Model<br><strong>Description:</strong> This dataset comprises 6 FFPE tissue sections, organized into 2 columns representing wild-type (WT) and CRND8 APP-overexpressing (TgCRND8) transgenic male mouse brains. The 3 rows correspond to time points of 2.5, 5.7, and 13.2 months of age for WT mice, and 2.5, 5.7, and 17.9 months for TgCRND8 mice. In the transgenic group, these time points reflect progressive stages of Alzheimer’s disease pathology, specifically mild, moderate, and advanced amyloid-β (Aβ) deposition.<br>SpatialZoomer extracted Alzheimer’s disease progression–related signals at specific scales, for example C18 at scale 6.0, C17 at scale 8.0, and C21 at scale 10.5.<br><strong>Cells:</strong> 349,063 &nbsp;&nbsp; <strong>Genes:</strong> Xenium Mouse Brain Gene Expression Panel plus 99 Custom Genes (347 genes)<br><strong>Original Data Download:</strong> <a href="https://www.10xgenomics.com/datasets/xenium-in-situ-analysis-of-alzheimers-disease-mouse-model-brain-coronal-sections-from-one-hemisphere-over-a-time-course-1-standard" target="_blank">Link</a>',
  '<strong>Dataset 2:</strong> CosMx SMI, Mouse Brain<br><strong>Description:</strong> Coronal hemisphere section.<br><strong>Cells:</strong> 48,556 &nbsp;&nbsp; <strong>Genes:</strong> CosMx Mouse Neuroscience RNA panel (960 genes)<br><strong>Original Data Download:</strong> <a href="https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-mouse-brain-ffpe-dataset/" target="_blank">Link</a>',         // Dataset2
  '<strong>Dataset 3:</strong> Xenium Prime, Ovarian cancer<br><strong>Description:</strong> Ovarian Papillary Serous Carcinoma tissue section.<br><strong>Cells:</strong> 407,124 &nbsp;&nbsp; <strong>Genes:</strong> Xenium Prime 5K Human Pan Tissue and Pathways Panel plus 100 Custom Genes (5101 genes)<br><strong>Original Data Download:</strong> <a href="https://www.10xgenomics.com/datasets/xenium-prime-ffpe-human-ovarian-cancer" target="_blank">Link</a>',       // Dataset3
  '<strong>Dataset 4:</strong> Xenium Prime, Cervical cancer<br><strong>Cells:</strong> 840,387 &nbsp;&nbsp; <strong>Genes:</strong> Xenium Prime 5K Human Pan Tissue and Pathways Panel plus 100 Custom Genes (5101 genes)<br><strong>Original Data Download:</strong> <a href="https://www.10xgenomics.com/datasets/xenium-prime-ffpe-human-cervical-cancer" target="_blank">Link</a>'
  ];
