...
def plot_distance_scale_heatmap(
    ...
    colorbar_vmax_symlog=0.5,            # maximum value for symlog scale (values above use brightest color)
...
def plot_distance_scale_heatmap_by_groups(
    ...
    # ------------------ 7) Plot heatmaps ------------------
    titles = [f"All (n={len(mf)})"] + [f"{g} (n={n_seeds_groups[g]})" for g in groups_order]
